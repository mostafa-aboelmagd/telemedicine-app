  ...
  const handleSubmit = async () => {
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_SERVER_NAME}/doctor/AppointmentResults/${appointment_id}/submitresults`,
        {
          method: "POST",
          headers: {
        ...
        <View style={styles.container}>
          ...
          <View style={styles.textFieldRow}>
            ...
            {specialityReferral.length > 0 && (
              <TouchableOpacity
                onPress={clearSpecialityReferral}
                style={styles.clearButton}
              >
                <Feather name="x-circle" size={24} color="gray" />
              </TouchableOpacity>
          ...
          <View style={styles.textFieldRow}>
            ...
            {specialityReferralNotes.length > 0 && (
              <TouchableOpacity
                onPress={clearSpecialityReferralNotes}
                style={styles.clearButton}
              >
                <Feather name="x-circle" size={24} color="gray" />
              </TouchableOpacity>
            ...
            <View style={styles.modalBackground}>
              <View style={styles.modalContainer}>
                <Text style={styles.modalText}>
                  Do you want a follow-up appointment?
                </Text>
