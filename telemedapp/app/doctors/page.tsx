    ...
    return (
        <main className='space-y-12'>
            ...
            <section className='max-w-full md:max-w-[90%] lg:max-w-[75%] mx-auto grid grid-cols-2 md:grid-cols-3 gap-4 h-lvh'>
                ...
                <FilterComponent minFees={minMaxFees.min} maxFees={minMaxFees.max} handleOpenModal={handleOpenModal} openModal={openModal} handleChangeOptions={handleChangeOptions} handleChangeFilterDrop={handleChangeFilterDrop} handleResetFilters={handleResetFilters} />
                {doctors ? <DoctorGrid doctors={filteredDoctors} /> : <div> Loading...</div>}
            </section>
        </main>
    )
}
