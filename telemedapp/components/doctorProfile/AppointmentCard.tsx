    ...
    <div className="bg-neutral-50 rounded-3xl md:p-6 p-4 shadow-lg flex flex-col md:space-y-3 space-y-2" key={appointment.appointment_id}>
      ...
      <div className="flex flex-col space-y-2">
        <div className="text-sm text-gray-600">
          <p>
            <strong>Date:</strong> {" " + appointment.doctor_availability_day_hour.slice(0, 10)}
          </p>
          <p>
            <strong>Time & Duration:</strong>
            {" " + appointment.doctor_availability_day_hour.slice(11, 16)}{" "} | {appointment.appointment_duration + " mins"}
          </p>
          <p>
      ...
      <div className="flex flex-row justify-between gap-4">
        <Link href={`/doctorProfile/patientHistory/${appointment.appointment_patient_id}`} className="w-1/2">
