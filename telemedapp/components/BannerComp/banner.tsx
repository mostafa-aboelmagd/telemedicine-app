        ...
        <section className="h-screen flex ml-[12.5%]">
            <div className='flex flex-col h-full space-y-4'>
                ...
                <div className='flex flex-col space-y-4 max-w-[80%]'>
                    <Link href="/doctors">
                        <button className={buttonStyles.gradient_button + " px-12 py-2 my-2 text-lg text-white rounded-lg w-full "}>Explore Our Doctors</button>
                    </Link>
                    <button className="border border-[#035fe9] rounded-lg text-[#035fe9] px-12 py-2">Get Matched With a Doctor</button>
                </div>
            </div>
            <div>
