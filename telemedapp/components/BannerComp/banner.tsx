            ...
            <div className='flex flex-col h-full space-y-4'>
                ...
                <div className='flex flex-col items-center space-y-4 md:max-w-[80%]'>
                    <Link className='min-w-[80%] md:min-w-full' href="/doctors">
                        <button className={buttonStyles.gradient_button + " md:px-12 py-2 my-2 text-lg text-white rounded-lg w-full "}>Explore Our Doctors</button>
                    </Link>
                    <button className="border border-[#035fe9] rounded-lg text-[#035fe9] min-w-[80%] md:min-w-full md:px-12 py-2">Get Matched With a Doctor</button>
                </div>
            </div>
            <div>
