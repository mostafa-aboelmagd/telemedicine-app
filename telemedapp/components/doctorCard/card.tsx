    ...
    <div className="bg-white rounded-3xl p-4 flex flex-col space-y-8">
      <div className="flex space-x-2">
        ...
        <div className="flex flex-col space-y-2 grow">
          ...
          <div className="flex justify-between items-center">
            ...
            <p className="text-[#035fe9] text-sm flex items-center">
      ...
      <div className="flex justify-between items-center space-x-2">
        ...
        <div className="text-md grow">
          <span className="text-[#035fe9]">{doctor.fees60min} EGP</span> / 60
          min <span className="text-[#035fe9]">{doctor.fees30min} EGP</span> /
          30 min
        </div>
      </div>
